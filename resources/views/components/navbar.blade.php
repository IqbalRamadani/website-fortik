<nav class="bg-linear-to-br from-lkoamaru to-koamaru fixed w-full z-100 top-0 start-0 shadow-lg overflow-hidden">
    <div class="flex max-w-2xl md:max-w-3xl lg:max-w-7xl flex-wrap items-center justify-between mx-auto px-6 py-4 md:px-16 lg:px-24">
        ...
        <div>
            ...
            <button data-collapse-toggle="navbar-dropdown" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-white rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-dropdown" aria-expanded="false">
