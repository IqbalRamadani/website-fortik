<div class="min-h-screen bg-slate-900 relative mx-auto px-6 py-16 flex flex-col items-center text-center">
    ...
    <div class="fixed bottom-8 right-8 z-10">
        <a href="https://wa.me/6281218141629" target="_blank" rel="noopener noreferrer" class="group flex items-center justify-center bg-emerald-500 hover:bg-emerald-400 text-slate-900 font-bold rounded-full md:rounded-lg shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_25px_rgba(16,185,129,0.5)] transition-all transform hover:-translate-y-1 p-4 md:px-5 md:py-3">
            <i class="fa-brands fa-whatsapp text-2xl md:text-xl"></i>
            <span class="hidden md:block ml-2 tracking-wide">Admin</span>
        </a>
    </div>
</div>
