<div class="flex mx-auto h-fit max-h-screen bg-white bg-about-us-mobile md:bg-about-us bg-cover bg-center justify-items-center items-center px-6 py-12 md:py-20 lg:px-36 hidden-overflow">
    <div class="w-full max-w-6xl mx-auto">
        <div class="">
            ...
            <img src="{{ asset('images/logo-kabinet.png') }}" alt="logo kabinet" loading="lazy" class="w-80 md:w-140 mx-auto mb-8">
            <div class="flex justify-center ml-4">
                <span class="p-4 bg-linear-to-br from-lkoamaru to-koamaru rounded-lg text-center text-white font-bold text-xl md:text-3xl lg:text-4xl">Cerdas <span class="font-light">dalam</span> Berinovasi</span>
            </div>
