    ...
    <div class="max-w-7xl mx-auto px-12 py-6 lg:px-8 lg:py-16">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-endeavour/95 backdrop-blur-sm rounded-xl p-6 text-center">
                ...
                <h3 class="text-xl font-semibold text-white mb-2">Berdiri Sejak 2021</h3>
                <p class="text-white/80">Komunitas mahasiswa yang peduli dengan perkembangan teknologi digital</p>
            </div>
            ...
            <div class="bg-endeavour/95 backdrop-blur-sm rounded-xl p-6 text-center">
                ...
                <p class="text-white/80">Pelopor terdepan dalam inovasi dan standardisasi</p>
            </div>
