<x-layout>
    <div class="px-6 py-12 bg-white border-none">
        <div class="w-full max-w-6xl mx-auto">
            <!-- VISI Section -->
            <section class="mb-8">
                <h1 class="text-3xl md:text-4xl lg:text-5xl font-extrabold text-koamaru mb-4">VISI</h1>
                ...
                <hr class="w-full h-px bg-koamaru mt-8"></hr>
            </section>

            <!-- MISI Section -->
            <section class="mb-8">
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-extrabold text-koamaru mb-4">MISI</h2>
            ...
            <!-- TUJUAN Section -->
            <section class="mb-8">
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-extrabold text-koamaru mb-4">TUJUAN</h2>
                    <p class="text-sm md:text-lg lg:text-xl leading-relaxed text-justify">
